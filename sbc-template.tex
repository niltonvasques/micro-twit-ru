...
\author{Caio N. Lima\inst{1}, Gabriel Erbetta\inst{1}, Marino S. Santos
  \inst{1}, Nilton V. C. Junior\inst{1} }
...
\address{Departamento de Ciência da Computação -- Universidade Federal da Bahia
  ...
  \email{ricardopdf@hotmail.com} %ta armengado essa quebra de texto
}
