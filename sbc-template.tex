...
\begin{resumo}
  ...
  vivenciada pela comunidade universitária, no seu mais básico direito, a alimentação.
\end{resumo}
...
economia de tempo, comodidade, além de possuir dados reais que expelhem a realidade vivenciada
