...
%Como Usuário gostaria de informar um Status do RU
%
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{useCases.png}
...
\caption{This figure is an example of a figure caption taking more than one
  line and justified considering margins mentioned in Section~\ref{sec:Casos de uso}.}
